...
class Settings(BaseSettings):
    ...
    def _find_kubeconfig(self) -> str:
        ...
        candidates = [
            ...
            Path(__file__).parent.parent.parent / 'dashboard' / 'kubeconfig.yaml',
        ...
        return str(Path(__file__).parent.parent.parent / 'dashboard' / 'kubeconfig.yaml')

...
export const getMockAssets = () => [
  {
    ...
    baseUrl: "https://example.com/data/sample",
  },
  {
    id: "asset-2",
    name: "Sensor Readings",
    description: "Historical sensor readings from IoT devices",
    baseUrl: "https://example.com/data/sensors",
  },
  {
    id: "asset-3",
    name: "Product Catalog",
    description: "Complete product catalog with specifications",
    baseUrl: "https://example.com/data/products",
  },
]
    ...
    return response.map((contract: any) => {
      ...
      try {
        ...
        if (contract.assetsSelector) {
          accessPolicy += `, Asset: ${contract.assetsSelector.operandRight || "Unknown"}`
        }
      } catch (e) {

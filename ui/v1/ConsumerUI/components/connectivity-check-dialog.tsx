            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="text-sm">{results.catalog.message}</p>
                </div>
                ...
                >
                  ...
                  <p className="text-sm">{results.negotiations.message}</p>
                </div>

                <div
                  className={`p-4 rounded-md ${
                    results.transfers.status ? "bg-green-50 border border-green-200" : "bg-red-50 border border-red-200"
                  }`}
                >
                  <h3 className="font-medium mb-2 flex items-center">
                  ...
                  <p className="text-sm">{results.transfers.message}</p>
                </div>
              </div>

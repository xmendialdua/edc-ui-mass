...
# No Complatible con Mondragon-X

>[!important]
> Contenido proporcionado por [tractus-x-umbrella](https://github.com/eclipse-tractusx/tractus-x-umbrella/tree/main). Por lo tanto, puede no ser totalmente compatible con nuestra configuración. Para información especifica de Mondragon-X: [README](/README.md)
...
- Build the docker image by running the command - `docker build --build-arg JENA_VERSION=5.0.0 -t jena-fuseki-docker:5.0.0 --platform linux/amd64 .`
